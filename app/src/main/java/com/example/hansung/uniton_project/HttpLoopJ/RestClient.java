...
public class RestClient
{
    ...
    public static String BASE_URL = "http://192.168.1.38:3000"; //TODO: 서버 주소와 포트를 입력하세요
    ...
    public void post(Context context, String url, HttpEntity entity, String contentType , ResponseHandlerInterface responseHandlerInterface)
    {
